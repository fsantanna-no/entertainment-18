...
\begin{figure}[t]
\centering
\includegraphics[width=250px]{pingus-annotations}
...
\item [Structured:] programs use structured control mechanisms, such as
    \code{spawn} and \code{await} (to create and suspend an activity).
...
\begin{figure}[t]
\centering
\includegraphics[width=350px]{double-click}
...
\begin{figure}[t]
\centering
\includegraphics[width=250px]{states}
...
\begin{figure}[t]
\centering
\includegraphics[width=250px]{game-session-arrows}
...
\begin{figure}[t]
\centering
\includegraphics[width=250px]{pool}
